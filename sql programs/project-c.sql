...
create table TableProduct1(Product_Id int primary key,ProductTypeId int 
constraint tt foreign key(ProductTypeId)references TableProductCategory(Product_Category_Id)
,Product_Name varchar(500),Available_Quantity int,Total_Quantity int)
insert into TableProduct1 values(210,1002,'Apple',100,80)
insert into TableProduct1 values(211,1002,'Lenevo',200,150)
insert into TableProduct1 values(212,1003,'Samsung',150,100)
insert into TableProduct1 values(213,1004,'IFB',80,50)
insert into TableProduct1 values(214,1004,'LG',90,80)
insert into TableProduct1 values(215,1001,'Sony',50,30)
alter  table TableProduct1	 add price3 decimal
select * from TableProduct1
update TableProduct1 set price3=4000 where Product_Name='Apple'
update TableProduct1 set price3=25000 where Product_Name='Lenevo'
update TableProduct1 set price3=50000 where Product_Name='Samsung'
update TableProduct1 set price3=20000 where Product_Name='IFB'
update TableProduct1 set price3=30000 where Product_Name='LG'
update TableProduct1 set price3=60000 where Product_Name='Sony'

create table TableInvoiceDetails(Invoice_Detail_Id int primary key identity,
Customer_Name varchar(500),Customer_Contact varchar(15),Product_Category_Id int constraint c3
foreign key(Product_Category_Id)references TableProductCategory(Product_Category_Id),Product_Id int constraint c4 
foreign key(Product_Id)references
TableProduct(Product_Id),Gender Varchar(500),Invoice_Date datetime,Quantity decimal,Price 
decimal,CGST decimal,SGST decimal,
